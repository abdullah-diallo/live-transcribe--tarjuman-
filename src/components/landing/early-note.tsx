...
export function EarlyNote() {
  return (
    <section className="w-full max-w-5xl mx-auto px-6 py-16 sm:py-24">
      ...
      <Reveal delay={90}>
        <div className="mt-10 mx-auto max-w-2xl rounded-2xl border border-[var(--color-border-light)] bg-[var(--color-surface)] p-8 sm:p-10 text-center transition duration-200 hover:-translate-y-1 hover:border-[var(--color-accent)] hover:bg-[var(--color-surface-light)] hover:shadow-[0_10px_30px_rgba(var(--color-accent-rgb),0.18)]">
          <p
            dir="auto"
